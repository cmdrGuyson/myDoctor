        ...
        <div class="container">
            ...
            <div class="main">
                ...
                <div class="alert alert-warning" role="alert">
                    Please select the appropriate availability slot for your appointment!
                </div>


                <!--Table to display availabilities of doctors -->
                        ...
                        <c:forEach var="slot" items="${slots}" >
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class='btn btn-outline-primary' title="Channel Doctor" href="" data-toggle="modal" data-target="#removeSlotModal" onclick="change(${slot.getAvailabilitySlotID()})">
                                        <i class="fas fa-plus-circle"></i><span>Channel</span>
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <!-- Confirmation modal for adding appointment -->
                <div
                    class="modal fade"
                    id="removeSlotModal"
                    tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Do you want to make an appointment?</p>
